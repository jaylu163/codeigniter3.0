...
class Mail {
     ...
     */
    public  function sendEmail(PHPMailer $mail ,$emailConfig=array(),$title='',$to='',$msg='',$pathName=''){
        ...
        try {
            ...
            foreach ($toEmail as $email){
                $mail->AddAddress($email);// 多个人发 再复制一个方法出来
            }
            if($title){
                $mail->Subject  = $title;
            }else{
     ...
     * @param array $emailConfig
     */
    public  function sendCustomEmail(PHPMailer $mail,$emailConfig=array(),$to='',$msg='',$pathName=''){
