...
//erp域名切换
$new_erp_address = 'http://yfberpzyx.caissa.com.cn/freeline'; //http://80.66.40.84:80/freeline

$config['ERP_INTERFACE_URL'] = $new_erp_address.'/servlet/';
//自定义静态文件域名
...
//支付回调地址
$config['PAY_RETURN_URL'] = 'http://www199.caissa.com.cn';

//会员中心接口地址
//$config['MUMBER_CENTER_URL'] = 'http://172.16.37.93:8080/user-common/webservice/v1_0_0';
$config['MUMBER_CENTER_URL'] = 'http://yfbcis.caissa.me/openapi/';
...
$config['MUMBER_DOMAINS'] = array(
    ...
    'http://www199.caissa.com.cn/passclient/index.php?key=',
);
$config['MUMBER_LOGINOUT_DOMAINS'] = array(
    'http://www199.caissa.com.cn/passclient/index.php?act=loginout',
    'http://bbs1.caissa.com.cn/member.php?mod=logging&action=api_logout',
    'http://www.caissayl.com/ws/login.ashx?action=loginout',
);

$config['ERP_ORDER_IS_PAY'] = $new_erp_address.'/servlet/v1/OrderServlet?method=createFreelineOrder';
